...
def get_expected_output():
    ...
    return [
        ...
        ['"', 'skimage-denoise', '-I', 'OCR-D-BIN2', '-O', 'OCR-D-BIN-DENOISE', '-P', 'level-of-operation', 'page', '"',
         '\\'],
        ['"', 'tesserocr-deskew', '-I', 'OCR-D-BIN-DENOISE', '-O', 'OCR-D-BIN-DENOISE-DESKEW', '-P', 'operation_level',
         'page', '"', '\\'],
        ['"', 'cis-ocropy-segment', '-I', 'OCR-D-BIN-DENOISE-DESKEW', '-O', 'OCR-D-SEG', '-P', 'level-of-operation',
         'page', '"', '\\'],
        ['"', 'cis-ocropy-dewarp', '-I', 'OCR-D-SEG', '-O', 'OCR-D-SEG-LINE-RESEG-DEWARP', '"', '\\'],
        ['"', 'calamari-recognize', '-I', 'OCR-D-SEG-LINE-RESEG-DEWARP', '-O', 'OCR-D-OCR', '-P', 'checkpoint_dir',
